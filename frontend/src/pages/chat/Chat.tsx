          ...
          <div className={styles.chatContainer}>
            {!messages || messages.length < 1 ? (
              <Stack className={styles.chatEmptyState}>
                ...
                <h2 className={styles.chatEmptyStateSubtitle}>
                  Dies ist eine sichere, apetito-interne Umgebung. Sie können
                  persönliche oder vertrauliche Informationen in Ihren
                  Eingabeaufforderungen eingeben, aber Sie müssen die Antworten
                  immer noch auf Plausibilität/Glaubwürdigkeit und
                  Urheberrechtsverletzungen überprüfen, bevor Sie sie verwenden.
                  Im Zweifelsfall kontaktieren Sie bitte Ihren Vorgesetzten, den
                  Datenschutzbeauftragten oder die Rechtsabteilung.
                </h2>
                <h2 className={styles.chatEmptyStateSubtitle}>
                  Sie können in jeder beliebigen Sprache fragen :-)
                </h2>
              </Stack>
            ) : (
              <div
                  ...
                  <CommandBarButton
                    ...
                    styles={{
                      ...
                      root: {
                        color: "#FFFFFF",
                        background:
                          "radial-gradient(109.81% 107.82% at 100.1% 90.19%, #37772F 33.63%, #71C367 70.31%, #B4DFAE 100%)",
                      },
                      rootDisabled: {
                        background: "#BDBDBD",
                      },
